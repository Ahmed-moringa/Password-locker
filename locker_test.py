...
class TestCredentials(unittest.TestCase):
    ...
    def save_credential_test(self):
        """
        test case to test if object is saved into the credentials list.
        """
    ...
    def test_save_many_accounts(self):
        ...
        '''
        self.new_credential.save_details()
        test_credential = Credentials("Twitter","ahmedabdi","qwertyasdf") 
    ...
    def test_credential_exist(self):
        """
        test to check if we can return a true or false based on whether we find the credential.
        """
        self.new_credential.save_details()
        the_credential = Credentials("Twitter", "ahmedabdi", "qwertyasdf")  
